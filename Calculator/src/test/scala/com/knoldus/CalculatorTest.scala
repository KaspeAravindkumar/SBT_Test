...
class CalculatorTest extends AnyFlatSpec {
  ...
  "It" should "fail as assertion is wrong" in{
    val res = calculator.addition(5,8)
    assert(!(res == 20))
  }
  ...
  //case-6
  "It" should "fail assertion is wrong" in {
    val res = calculator.subtraction(10, 3)
    assert(!(res == 13))
  }
  ...
  //case-4
  "multiplication" should "fail " in {
    val res = calculator.multiplication(5,4)
    assert(!(res == 30))
  }
  ...
  //case-4
  "division" should "fail as expectation is wrong" in {
    val res = calculator.division(50, 10)
    assert(!(res == 50))
  }
  ...
  //case-3
  "modulus " should "fail assertion is wrong" in {
    val res = calculator.modulus(24, 4)
    assert(!(res == 4))
  }
  ...
  //case-4
  it should "fail assertion is false" in {
    val res = calculator.maximumOfTwo(100, 56)
    assert(!(res == 56))
  }
  ...
  //case-4
  it should "fail as assertion is false" in {
    val res = calculator.minimumOfTwo(30, 60)
    assert(!(res == 60))
  }
  ...
  //case-4
  it should "fail as assertion fails" in {
    val res = calculator.power(15, 3)
    assert(!(res == 225.0))
  }
  ...
  //case-3
  it should "fail assertion fails" in {
    val res = calculator.absolute(-5)
    assert(!(res == -5))
  }
